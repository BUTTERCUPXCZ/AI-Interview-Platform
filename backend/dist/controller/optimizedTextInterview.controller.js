 ...
 */
export const startTextInterviewOptimized = async (req, res) => {
    try {
 ...
 */
export const getNextQuestionOptimized = async (req, res) => {
    try {
        ...
        if (!nextQuestion) {
            ...
            const questionData = await generateSingleTextQuestion(session.domain, session.difficulty, session.interviewType, nextQuestionNumber);
 ...
 */
export const submitTextAnswerOptimized = async (req, res) => {
    try {
...
async function generateSingleTextQuestion(domain, difficulty, interviewType, questionNumber) {
...
async function evaluateAnswerInBackground(questionId, questionText, answer, session) {
    try {
        const evaluation = await evaluateTextAnswer(questionText, answer, session.domain, session.difficulty ?? "intermediate", session.interviewType ?? "technical");
